...
import { FaCamera, FaChevronLeft, FaChevronRight, FaVideo } from 'react-icons/fa6';
...
const PropertyRecommendation = () => {
    ...
    return (
        <RootLayout className="space-y-2 relative">
            <div className="w-full flex items-center justify-between">
                ...
                <div className="flex items-center gap-6">
                    <button
                        className={`custom-prevv text-white bg-primary hover:bg-blue-700 p-2 rounded-full z-10 ${isBeginning ? "cursor-not-allowed opacity-50" : "cursor-pointer"
                            }`}
                    ...
                    <button
                        className={`custom-nextt text-white bg-primary hover:bg-blue-700 p-2 rounded-full z-10 ${isEnd ? "cursor-not-allowed opacity-50" : "cursor-pointer"
                            }`}
                        disabled={isEnd}
                    >
                            ...
                            <div className="w-full h-auto p-1 space-y-3 group">
                                ...
                                <div className="w-full px-1 space-y-4">
                                    <div className="space-y-1">
                                        <Link to={`/property/${property.title}`} className="text-lg text-neutral-800 font-semibold">
                                            {property.title}
                                        </Link>
